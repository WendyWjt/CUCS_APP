...
const routes = [
    ...
    {
        path: 'rklefstad',
        loadChildren: () => __webpack_require__.e(/*! import() | rklefstad-rklefstad-module */ "rklefstad-rklefstad-module").then(__webpack_require__.bind(null, /*! ./rklefstad/rklefstad.module */ "./src/app/tab1/course-list/course-intro-ics45c/rklefstad/rklefstad.module.ts")).then(m => m.RklefstadPageModule)
    },
    {
        path: 'zwu',
        loadChildren: () => __webpack_require__.e(/*! import() | zwu-zwu-module */ "zwu-zwu-module").then(__webpack_require__.bind(null, /*! ./zwu/zwu.module */ "./src/app/tab1/course-list/course-intro-ics45c/zwu/zwu.module.ts")).then(m => m.ZwuPageModule)
    },
    {
        path: 'athornton',
        loadChildren: () => __webpack_require__.e(/*! import() | athornton-athornton-module */ "athornton-athornton-module").then(__webpack_require__.bind(null, /*! ./athornton/athornton.module */ "./src/app/tab1/course-list/course-intro-ics45c/athornton/athornton.module.ts")).then(m => m.AthorntonPageModule)
    }
];
let CourseIntroIcs45cPageRoutingModule = class CourseIntroIcs45cPageRoutingModule {
};
...
let CourseIntroIcs45cPageModule = class CourseIntroIcs45cPageModule {
};
...
let CourseIntroIcs45cPage = class CourseIntroIcs45cPage {
    constructor() { }
    ngOnInit() {
    }
};
...
//# sourceMappingURL=course-intro-ics45c-course-intro-ics45c-module-es2015.js.map