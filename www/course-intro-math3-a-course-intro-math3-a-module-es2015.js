...
const routes = [
    ...
    {
        path: 'rboderick',
        loadChildren: () => __webpack_require__.e(/*! import() | rboderick-rboderick-module */ "rboderick-rboderick-module").then(__webpack_require__.bind(null, /*! ./rboderick/rboderick.module */ "./src/app/tab1/course-list/course-intro-math3-a/rboderick/rboderick.module.ts")).then(m => m.RboderickPageModule)
    },
    {
        path: 'mkosters',
        loadChildren: () => __webpack_require__.e(/*! import() | mkosters-mkosters-module */ "mkosters-mkosters-module").then(__webpack_require__.bind(null, /*! ./mkosters/mkosters.module */ "./src/app/tab1/course-list/course-intro-math3-a/mkosters/mkosters.module.ts")).then(m => m.MkostersPageModule)
    }
];
let CourseIntroMath3APageRoutingModule = class CourseIntroMath3APageRoutingModule {
};
...
let CourseIntroMath3APageModule = class CourseIntroMath3APageModule {
};
...
let CourseIntroMath3APage = class CourseIntroMath3APage {
    constructor() { }
    ngOnInit() {
    }
};
...
//# sourceMappingURL=course-intro-math3-a-course-intro-math3-a-module-es2015.js.map