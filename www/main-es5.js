...
var routes = [
    ...
    {
        path: 'course-list',
        loadChildren: function () { return __webpack_require__.e(/*! import() | tab1-course-list-course-list-module */ "tab1-course-list-course-list-module").then(__webpack_require__.bind(null, /*! ./tab1/course-list/course-list.module */ "./src/app/tab1/course-list/course-list.module.ts")).then(function (m) { return m.CourseListPageModule; }); }
    },
    {
        path: 'class-material',
