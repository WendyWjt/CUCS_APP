...
const routes = [
    ...
    {
        path: 'esudderth',
        loadChildren: () => __webpack_require__.e(/*! import() | esudderth-esudderth-module */ "esudderth-esudderth-module").then(__webpack_require__.bind(null, /*! ./esudderth/esudderth.module */ "./src/app/tab1/course-list/course-intro-cs178/esudderth/esudderth.module.ts")).then(m => m.EsudderthPageModule)
    },
    {
        path: 'athomas',
        loadChildren: () => __webpack_require__.e(/*! import() | athomas-athomas-module */ "athomas-athomas-module").then(__webpack_require__.bind(null, /*! ./athomas/athomas.module */ "./src/app/tab1/course-list/course-intro-cs178/athomas/athomas.module.ts")).then(m => m.AthomasPageModule)
    }
];
let CourseIntroCs178PageRoutingModule = class CourseIntroCs178PageRoutingModule {
};
...
let CourseIntroCs178PageModule = class CourseIntroCs178PageModule {
};
...
let CourseIntroCs178Page = class CourseIntroCs178Page {
    constructor() { }
    ngOnInit() {
    }
};
...
//# sourceMappingURL=course-intro-cs178-course-intro-cs178-module-es2015.js.map