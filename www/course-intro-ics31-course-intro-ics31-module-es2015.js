...
const routes = [
    ...
    {
        path: 'dgkay',
        loadChildren: () => __webpack_require__.e(/*! import() | dgkay-dgkay-module */ "dgkay-dgkay-module").then(__webpack_require__.bind(null, /*! ./dgkay/dgkay.module */ "./src/app/tab1/course-list/course-intro-ics31/dgkay/dgkay.module.ts")).then(m => m.DgkayPageModule)
    },
    {
        path: 'rwang',
        loadChildren: () => __webpack_require__.e(/*! import() | rwang-rwang-module */ "rwang-rwang-module").then(__webpack_require__.bind(null, /*! ./rwang/rwang.module */ "./src/app/tab1/course-list/course-intro-ics31/rwang/rwang.module.ts")).then(m => m.RwangPageModule)
    },
    {
        path: 'igassko',
        loadChildren: () => __webpack_require__.e(/*! import() | igassko-igassko-module */ "igassko-igassko-module").then(__webpack_require__.bind(null, /*! ./igassko/igassko.module */ "./src/app/tab1/course-list/course-intro-ics31/igassko/igassko.module.ts")).then(m => m.IgasskoPageModule)
    },
    {
        path: 'rklefstad',
        loadChildren: () => __webpack_require__.e(/*! import() | rklefstad-rklefstad-module */ "rklefstad-rklefstad-module").then(__webpack_require__.bind(null, /*! ./rklefstad/rklefstad.module */ "./src/app/tab1/course-list/course-intro-ics31/rklefstad/rklefstad.module.ts")).then(m => m.RklefstadPageModule)
    },
    {
        path: 'salfaro',
        loadChildren: () => __webpack_require__.e(/*! import() | salfaro-salfaro-module */ "salfaro-salfaro-module").then(__webpack_require__.bind(null, /*! ./salfaro/salfaro.module */ "./src/app/tab1/course-list/course-intro-ics31/salfaro/salfaro.module.ts")).then(m => m.SalfaroPageModule)
    }
];
let CourseIntroIcs31PageRoutingModule = class CourseIntroIcs31PageRoutingModule {
};
...
let CourseIntroIcs31PageModule = class CourseIntroIcs31PageModule {
};
...
let CourseIntroIcs31Page = class CourseIntroIcs31Page {
    constructor() { }
    ngOnInit() {
    }
};
...
//# sourceMappingURL=course-intro-ics31-course-intro-ics31-module-es2015.js.map