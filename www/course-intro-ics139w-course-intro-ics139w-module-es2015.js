...
const routes = [
    ...
    {
        path: 'khermans',
        loadChildren: () => __webpack_require__.e(/*! import() | khermans-khermans-module */ "khermans-khermans-module").then(__webpack_require__.bind(null, /*! ./khermans/khermans.module */ "./src/app/tab1/course-list/course-intro-ics139w/khermans/khermans.module.ts")).then(m => m.KhermansPageModule)
    },
    {
        path: 'salfaro',
        loadChildren: () => __webpack_require__.e(/*! import() | salfaro-salfaro-module */ "salfaro-salfaro-module").then(__webpack_require__.bind(null, /*! ./salfaro/salfaro.module */ "./src/app/tab1/course-list/course-intro-ics139w/salfaro/salfaro.module.ts")).then(m => m.SalfaroPageModule)
    },
    {
        path: 'rblack',
        loadChildren: () => __webpack_require__.e(/*! import() | rblack-rblack-module */ "rblack-rblack-module").then(__webpack_require__.bind(null, /*! ./rblack/rblack.module */ "./src/app/tab1/course-list/course-intro-ics139w/rblack/rblack.module.ts")).then(m => m.RblackPageModule)
    }
];
let CourseIntroIcs139wPageRoutingModule = class CourseIntroIcs139wPageRoutingModule {
};
...
let CourseIntroIcs139wPageModule = class CourseIntroIcs139wPageModule {
};
...
let CourseIntroIcs139wPage = class CourseIntroIcs139wPage {
    constructor() { }
    ngOnInit() {
    }
};
...
//# sourceMappingURL=course-intro-ics139w-course-intro-ics139w-module-es2015.js.map